...
const MODE = { driving: 'driving', transit: 'transit' }
...
class QQMapWX {
  ...
  geocoder(options) {
    ...
    const requestParam = { address: options.address, output: 'json', key: that.key }
    if (options.region) {
  ...
  calculateDistance(options) {
    ...
    if (requestParam.mode == 'straight') {
      var locationsuccess = function (result) {
        ...
        const data = { message: 'query ok', result: { elements: [] }, status: 0 }
